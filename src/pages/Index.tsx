      ...
      <header className="sticky top-0 z-50 bg-background border-b border-border">
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <Button size="sm" className="text-sm font-medium bg-card text-foreground hover:bg-muted">
              Get Started
            </Button>
          </div>
        </div>
      ...
      <section className="max-w-4xl mx-auto px-6 pt-20 pb-16">
        <div className="text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-12">
            ...
            >
              <Button size="lg" className="h-12 px-8 text-base font-medium bg-card text-foreground hover:bg-muted">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {automationSystems.map((system, index) => {
            ...
            return (
              <div
                key={index}
                className="group border border-border rounded-lg p-6 hover:border-accent hover:shadow-sm transition-all duration-200 cursor-pointer"
              >
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0">
                    <div className="w-10 h-10 rounded-lg bg-muted flex items-center justify-center group-hover:bg-accent group-hover:text-accent-foreground transition-colors duration-200">
        ...
        <div className="max-w-6xl mx-auto px-6 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-stretch gap-4">
            ...
            <div className="md:text-right">
              <p className="text-sm text-muted-foreground font-normal leading-relaxed md:whitespace-nowrap">
